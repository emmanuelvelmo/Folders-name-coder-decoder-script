...
lista_caracteres = ['b','0','j','R','f','H','g','9','a','1','k','S','m','2','ñ','o','3','p','q','4','r','s','t','5','u','v','w','6','x','y','z','7','A','B','C','8','D','E','F','G','I','J','K','L','M','N','O','P','Q','U','V','W','X','Y','Z','á','é','í','ó','ú','Á','É','Í','Ó','Ú','.','-','_','#','(',')',' '] # Caracteres mezclados para codificación
